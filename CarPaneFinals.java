...
public interface CarPaneFinals {
	...
	ObservableList<String> colors = FXCollections.observableArrayList("שחור", "לבן", "אדום","אפור","ברונזה","לבן פנינה");
	...
	ObservableList<String> originally = FXCollections.observableArrayList("פרטי", "ליסינג מימוני","ליסינג תפעולי","השכרה","חברה");
